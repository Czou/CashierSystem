			...
			try {
				if (BaseUtils.IsNotEmpty(t)
					...
					if (products != null && products.size() > 0) {
						...
						Dao<ProductInfo, Integer> productDao = ormOpearationDao.getDao(ProductInfo.class);
						// 第一次更新数据，全部更新
